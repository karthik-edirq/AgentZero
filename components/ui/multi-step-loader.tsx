        ...
        return (
          ...
          >
            ...
            <span
              className={cn(
                "text-foreground",
                value === index && "text-primary opacity-100 font-medium"
              )}
            >
              {loadingState.text}
            </span>
...
export const MultiStepLoader = ({
  ...
  const state = currentStep !== undefined ? currentStep : internalState;

  useEffect(() => {
    if (currentStep !== undefined) {
      // Controlled mode - use provided currentStep
      return;
    }
      ...
      {loading && (
        ...
        >
          <div className="h-96  relative">
            <LoaderCore value={state} loadingStates={loadingStates} />
          </div>

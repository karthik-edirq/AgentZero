...
"[project]/app/api/email-generator/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
Make the email realistic and tailored to the ${businessFunction} department at ${organization}. The email should be professional, well-formatted, and convincing.`;
        ...
        const callGeminiAPI = async (modelName, apiVersion = "v1beta")=>{
        ...
        try {
            ...
            if (jsonMatch) {
                ...
                const bodyMatch = generatedText.match(/body[":\s]+"([^"]+)"/i) || generatedText.match(/Body[:\s]+([\s\S]+)/i);
                emailData = {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__82a39efa._.js.map